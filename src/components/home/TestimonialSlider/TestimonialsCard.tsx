...
const testimonialsCard: React.FC<CardProps> = ({ stars, content, name, designation }) => {
  return (
    <div className="slides w-full h-[300px] relative box bg-white border border-black px-7 py-8 rounded-xl">
      ...
      <div className="flex items-center gap-5 absolute bottom-6">
        ...
        <div className="flex flex-col">
          <h5 className="text-gray-900 content font-medium transition-all duration-200">
            {name}
          </h5>
          <span className="text-sm leading-6 text-gray-500">{designation}</span>
        </div>
      </div>
    </div>
  );
